    ...
    def optimize_parameters(self, current_iter):
        ...
        if current_iter % self.net_d_iters == 0 and current_iter > self.net_g_start_iter:
            ...
            if current_iter > self.net_d_start_iter:
                ...
                last_layer = self.net_g.module.generator.blocks[-2].weight
        ...
        if  current_iter > self.net_d_start_iter:
            ...
            # if not torch.any(torch.isnan(l_d_real)) and not torch.any(torch.isnan(l_d_fake)):
            #     l_d_real.backward()
            l_d_fake.backward()
